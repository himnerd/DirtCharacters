...
public class ContractSignOptionsGUI extends InventoryGUI {
    ...
    public ContractSignOptionsGUI(DirtCharacters plugin, ContractData draft) {
        this.plugin = plugin;
        this.draft = draft;
    }
    ...
    public void decorate(Player player) {
        ...
        addButton(15, new InventoryButton()
                ...
                .consumer(e -> {
                    ...
                    plugin.getGUIManager().openGUI(
                            new CharacterSelectGUI(plugin, "\u00a7aSelect First Signer", living,
    ...
    private void selectSecondSigner(Player creator, CharacterData firstSigner, List<CharacterData> allLiving) {
        ...
        plugin.getPlatformScheduler().runAtEntity(creator, () ->
                plugin.getGUIManager().openGUI(
                        new CharacterSelectGUI(plugin, "\u00a7aSelect Second Signer", remaining,
    ...
    private void sendToBothSigners(Player creator, CharacterData firstSigner, CharacterData secondSigner) {
        ...
        com.dirt.characters.data.MailItem mail = new com.dirt.characters.data.MailItem();
