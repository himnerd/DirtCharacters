...
public class MarriageConfirmGUI extends InventoryGUI {
    ...
    public MarriageConfirmGUI(DirtCharacters plugin, UUID targetPlayerUUID) {
        this.plugin = plugin;
        ...
        addButton(11, new InventoryButton()
                ...
                .consumer(e -> {
                    ...
                    if (targetPlayer != null) {
                        targetPlayer.sendMessage("§eYou have received a marriage request from §f" + myData.getFirstName() + " " + myData.getLastName() + "§e. Check your mailbox (/dc).");
                    }
                })
        );
