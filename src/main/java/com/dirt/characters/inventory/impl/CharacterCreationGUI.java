...
public class CharacterCreationGUI extends InventoryGUI {
    ...
    public CharacterCreationGUI(DirtCharacters plugin) {
        this.plugin = plugin;
    }
    ...
    public void decorate(Player player) {
        ...
        addButton(16, new InventoryButton()
                ...
                .consumer(e -> {
                    ...
                    plugin.getPlatformScheduler().runAtEntityLater(p, () ->
        ...
        addButton(22, new InventoryButton()
                ...
                .consumer(e -> {
                    ...
                    if (plugin.getCharacterManager().hasCharacter(p.getUniqueId())) {
                        plugin.getPlatformScheduler().runAtEntity(p, p::closeInventory);
                        return;
                    }
                    ...
                    // Let the rest of the suite react to a brand-new character.
                    Bukkit.getPluginManager().callEvent(new CharacterCreatedEvent(p));
