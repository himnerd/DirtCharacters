...
public class ContractListGUI extends InventoryGUI {
    ...
    public ContractListGUI(DirtCharacters plugin, List<ContractData> contracts, int page, InventoryGUI backGui) {
        this.plugin = plugin;
    ...
    public ContractListGUI(DirtCharacters plugin, UUID businessId, UUID playerUuid, int page) {
        this.plugin = plugin;
        this.page = page;
        if (plugin.getContractManager() != null) {
            if (businessId != null) {
                this.contracts = plugin.getContractManager().getContractsByBusiness(businessId);
                // The business screen lives in DirtBiz; contracts opened from
                // there simply close back to the inventory.
                this.backGui = null;
