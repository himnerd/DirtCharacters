...
/** Reusable paged picker over living characters. */
public class CharacterSelectGUI extends InventoryGUI {
    ...
    public CharacterSelectGUI(DirtCharacters plugin, String title, List<CharacterData> candidates,
    ...
    public void decorate(Player player) {
        ...
        for (int i = start; i < end; i++) {
            ...
            addButton(i - start, new InventoryButton()
                    ...
                    .consumer(e -> {
                        ...
                        p.closeInventory();
                        plugin.getPlatformScheduler().runAtEntityLater(p, () -> onSelect.accept(candidate), 1L);
                    })
            );
        }
        ...
        if (page > 0) {
            ...
            addButton(45, new InventoryButton()
                    ...
                    .consumer(e -> plugin.getGUIManager().openGUI(
                            new CharacterSelectGUI(plugin, title, candidates, onSelect, backGui, prev),
        ...
        if (end < candidates.size()) {
            ...
            addButton(53, new InventoryButton()
                    ...
                    .consumer(e -> plugin.getGUIManager().openGUI(
                            new CharacterSelectGUI(plugin, title, candidates, onSelect, backGui, next),
                            (Player) e.getWhoClicked()))
            );
        }
