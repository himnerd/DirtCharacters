...
public class FamilyGUI extends InventoryGUI {
    ...
    public FamilyGUI(DirtCharacters plugin) {
        this.plugin = plugin;
    }
    ...
    private void sendChildBearingRequest(Player player, CharacterData data) {
        ...
        if (spousePlayer != null) {
            spousePlayer.sendMessage("\u00a7eYou have received a child bearing request from \u00a7f" + data.getFirstName() + " " + data.getLastName() + "\u00a7e. Check your mailbox (/dc).");
        }
    }
