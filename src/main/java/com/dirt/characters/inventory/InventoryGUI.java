package com.dirt.characters.inventory;
...
public abstract class InventoryGUI implements InventoryHandler {
    ...
    public void onClick(InventoryClickEvent event) {
        ...
        // Only handle clicks in the GUI itself — Geyser/Bedrock clicks in the
        // player's own inventory report slots that overlap GUI button slots
        if (!this.getInventory().equals(event.getClickedInventory())) return;
