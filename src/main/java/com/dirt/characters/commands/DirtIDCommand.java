...
import com.dirt.characters.inventory.impl.IDViewGUI;
...
public class DirtIDCommand implements CommandExecutor, TabCompleter {
    private final DirtCharacters plugin;

    public DirtIDCommand(DirtCharacters plugin) {
        this.plugin = plugin;
    }
